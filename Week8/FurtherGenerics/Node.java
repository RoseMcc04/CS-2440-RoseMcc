...
public class Node<E>
{
    // Invariant of the Node<E> class:
    //   1. The node's Eeger data is in the instance variable data.
     ...
     * @note
     *   A wrong answer occurs for lists longer than E.MAX_VALUE.     
     **/   
	...
	public static <E> Node<E>[ ] listPart(Node<E> start, Node<E> end)
    {
        ...
        // cause a NullPoEerException if start is null.
